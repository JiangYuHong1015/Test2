...
<div class="i-sale clearfix">
	<ul>
					...
					<ul class="i-sale-con clearfix">
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale1129.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
		...
		全球五星级航空公司【港龙、国泰】专业承载，更有机会品尝哈根达斯冰激凌！</p>
						...
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale02_1212.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
									<h3>巴厘岛7日5晚自由行</h3>
						...
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale03_1212.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
									<h3>韩国首尔5日4晚跟团游</h3>
						...
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale04_1212.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
						...
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale05_1212.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
						...
						<li>
							<a href="travel/travel_message.html"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/sale06_1212.jpg" height="255" width="279" alt="">
								<div class="i-sale-p">
									<h3>新加坡5日4晚自由行</h3>
					...
					<div class="i-sale-tg">
						<a href="#"><img src="${pageContext.request.contextPath }/statics/images/img/sale-t1129.jpg" alt=""></a>
					</div>
				</div>
		...
		<li class="i-line sale-show i-sale-wrapone">
			...
			<div class="i-sale-one">
				...
				<div class="sale-con i_show">
					<ul class="i-sale-con clearfix">
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_01_xxx1213.jpg" height="174" width="279" alt="">
						...
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_02_xxx1213.jpg" height="174" width="279" alt="">
						...
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_03_xxx1213.jpg" height="174" width="279" alt="">
						...
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_04_xxx1213.jpg" height="174" width="279" alt="">
						...
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_05_xxx1213.jpg" height="174" width="279" alt="">
						...
						<li>
							<a href="hotelDetail.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="${pageContext.request.contextPath }/statics/images/img/hotel279174_06_xxx1213.jpg" height="174" width="279" alt="">
					...
					<div class="i-sale-tg">
						<a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload278-518.gif" data-original="images/img/jiudian_t_278518_xxx1130.jpg" height="518" width="278" alt=""></a>
					</div>
				</div>
				...
				<div class="sale-con">
					<ul class="i-sale-con clearfix">
						<li>
							<a href="#"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/jiudian279174_xxx1130.jpg" height="174" width="279" alt="">
									<h4>【北京】四季青元海景酒店</h4>
									<span class="i-price">
...
<div class="i-push clearfix">
	<div class="i-push-left"><a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload281-171.gif" data-original="${pageContext.request.contextPath }/statics/images/img/jd_bottom_xxx1130_11.jpg" height="171" width="281" alt=""></a></div>
	<div class="i-push-right"><a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload856-171.gif" data-original="${pageContext.request.contextPath }/statics/images/img/jd_bottom_xxx1130.jpg" height="171" width="856" alt=""></a></div>
</div>
<!-- 酒店下方推广广告结束 -->
		...
		<li class="i-line sale-show i-sale-wrapone">
			...
			<div class="i-sale-one">
				...
				<div class="sale-con i_show">
					...
					<div class="i-sale-tg">
						<a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload278-518.gif" data-original="images/img/ticket278518-xxx1201.jpg" height="518" width="278" alt=""></a>
					</div>
				</div>
				...
				<div class="sale-con">
					...
					<div class="i-sale-tg">
						<a href="#"><img src="${pageContext.request.contextPath }/statics/images/img/ticket278518-xxx1201.jpg" height="518" width="278" alt=""></a>
					</div>
				</div>
					...
					<ul class="i-sale-con clearfix">
						<li>
							<div class="i-idea-tj">
								<span></span>
								<a href="travel/travel_message.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl01_0314.jpg" height="173" width="279" alt=""></a>
							</div>
						...
						<li>
							<div class="i-idea-tj">
							 	<span></span>
							 	<a href="travel/travel_message.html"> 
									<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl02_0314.jpg" height="173" width="279" alt="">
								</a>
							</div>
						...
						<li>
							<div class="i-idea-tj">
								<span></span>
								<a href="travel/travel_message.html"> 
									<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl03_0314.jpg" height="173" width="279" alt="">
								</a>
							</div>
						...
						<li>
							<div class="i-idea-tj">
								<span></span>
								<a href="travel/travel_message.html"> 
									<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl04_0314.jpg" height="173" width="279" alt="">
								</a>
							</div>
						...
						<div class="i-idea-tj">
							<span></span>
							<a href="travel/travel_message.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl05_0314.jpg" height="173" width="279" alt="">
							</a>
						</div>
						...
						<div class="i-idea-tj">
							<span></span>
							<a href="travel/travel_message.html"> 
								<img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload279-173.gif" data-original="images/img/lygl06_0314.jpg" height="173" width="279" alt="">
							</a>
						</div>
			...
			<div class="i-sale-one">
				...
				<div class="sale-con i_show">
					...
					<ul class="i-sale-con clearfix">
						<li>
							<a href="#"> 
								<img src="${pageContext.request.contextPath }/statics/images/img/idea279173_xxx1201.jpg" height="173" width="279" alt=""></a>
...
<!-- 攻略下方推广广告开始 -->
<div class="i-push clearfix">
	<div class="i-push-left"><a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload281-171.gif" data-original="${pageContext.request.contextPath }/statics/images/img/gl_bottom_xxx1130_07.jpg" height="171" width="281" alt=""></a></div>
	<div class="i-push-right"><a href="#"><img class="lazy" src="${pageContext.request.contextPath }/statics/images/icon/lazyload856-171.gif" data-original="${pageContext.request.contextPath }/statics/images/img/gl_bottom_xxx1130.jpg" height="171" width="856" alt=""></a></div>
</div>
<!-- 攻略下方推广广告结束 -->
	...
	<div class="i_area">
		...
		<div class="i_organization">
			<ul class="clearfix">
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/Ireland.jpg" height="40" width="100" alt="">
					<p>澳大利亚旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/jp_jiuzhou.jpg" height="40" width="100" alt="">
					<p>福建旅游局</p>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/jiangsulogo.jpg" height="40" width="100" alt="">
					<p>以色列旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/Korea.jpg" height="40" width="100" alt="">
					<p>海南省旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/letianlogo.jpg" height="40" width="100" alt="">
					<p>南通市旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/liaoning.jpg" height="40" width="100" alt="">
					<p>柳州旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/Liuzhou.jpg" height="40" width="100" alt="">
					<p>夏威夷旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/Nanjing.jpg" height="40" width="100" alt="">
					<p>洛杉矶旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/nantong.jpg" height="40" width="100" alt="">
					<p>德阳市旅游局</p>
					</a>
				</li>
				<li>
					<a href="#">
					<img src="${pageContext.request.contextPath }/statics/images/icon/new_austr.jpg" height="40" width="100" alt="">
					<p>新西兰旅游局</p>
					</a>
				</li>
				<li>
...
<div class="i_download">
	<div class="i_area clearfix">
		...
		<div class="i_downright">
			<div class='i_wechat'>
				<img src="${pageContext.request.contextPath }/statics/images/icon/i_wechat_11.jpg" alt="">
				<span>微信公众平台</span>
			</div>
			<div class="i_APP">
				<img src="${pageContext.request.contextPath }/statics/images/icon/i_APP_11.jpg" alt="">
				<span>APP下载</span>
			</div>
		</div>
	</div>
...
<script src="${pageContext.request.contextPath }/statics/lib/star-rating/star-rating.js"></script>
<script src="${pageContext.request.contextPath }/statics/lib/jquery.lazyload.js"></script>
